...
const applyTheme = () => {
  ...
  //theme mode
  themeStorage.setItem('hello-istanbul-theme', theme);
  ...
  //peek section
  for (let i = 0; i < 3; i++) {
    peekImgs[i].setAttribute('src', `assets/img/img${i + 1}_${theme}.jpg`);
...
toggleSwitch.checked = themeStorage.getItem('hello-istanbul-theme') === 'dark' ? true : false;
applyTheme();
